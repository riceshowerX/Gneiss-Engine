...
class Image:
    ...
    def add_watermark(self, watermark: Union[str, Path, PILImage.Image], 
                      position: str = "center", 
                      opacity: float = 0.5,
        ...
        if position == "center":
            ...
            x, y = base_width - mark_width - padding, base_height - mark_height - padding
        else:
    ...
    def add_text_watermark(self, text: str, 
                          position: str = "center", 
                          font_size: int = 36,
        ...
        if position == "center":
            ...
            x, y = base_width - text_width - padding, base_height - text_height - padding
        else:
            raise ValueError(f"Invalid position: {position}")
    ...
    def rotate(self, angle: float, expand: bool = False, 
        ...
        Returns:
            The Image instance for method chaining.
        """
        self.image = self.image.rotate(angle, resample=resample, expand=expand, fillcolor=fillcolor)
        return self
    ...
    def __str__(self) -> str:
        ...
        return f"Image(path='{self.path}', format='{self.format}', size={width}x{height})"
