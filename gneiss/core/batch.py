...
class BatchProcessor:
    ...
    def process_images(self, 
                      ...
                      show_progress: bool = True) -> Dict[str, Union[str, Exception]]:
        """
    ...
    def add_watermark_to_images(self, 
                               image_paths: List[Union[str, Path]], 
    ...
    def add_text_watermark_to_images(self, 
                                    image_paths: List[Union[str, Path]], 
                                    text: str,
                                    position: str = "center",
                                    font_size: int = 36,
    ...
    def strip_metadata_from_images(self, 
                                 image_paths: List[Union[str, Path]], 
                                 output_dir: Optional[Union[str, Path]] = None,
                                 output_format: Optional[str] = None,
                                 show_progress: bool = True) -> Dict[str, Union[str, Exception]]:
