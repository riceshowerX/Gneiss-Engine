...
def batch_rename(files: List[Union[str, Path]], 
                pattern: str, 
                replacement: str,
                use_regex: bool = False) -> Dict[str, str]:
    """
...
def generate_sequential_names(directory: Union[str, Path], 
                             base_name: str, 
                             extension: str, 
                             start_number: int = 1,
                             padding: int = 3) -> List[str]:
    """
